                ...
                >
                    ...
                    <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-10">
                        <div className="space-y-6 text-center lg:text-left">
                            <h3 className="text-3xl md:text-4xl font-black text-[#111827] uppercase tracking-tighter">
                                Contact Us
                            </h3>
                            ...
                            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-8 pt-2">
                                <div className="text-left">
                                    ...
                                    <a href="mailto:support@studlyf.com" className="flex items-center gap-2 text-[#7C3AED] font-bold hover:underline">
                                        <Mail size={16} />
                                        support@studlyf.com
                                    </a>
                                </div>
                                ...
                                <div className="text-left">
                                    ...
                                    <a href="https://wa.me/916361158952" className="flex items-center gap-2 text-[#25D366] font-bold hover:underline">
                        ...
                        <div className="flex flex-col items-center">
                            <motion.button
                                ...
                                whileTap={{ scale: 0.98 }}
                                className="bg-[#111827] text-white pl-4 pr-8 py-4 rounded-xl font-bold uppercase tracking-wider text-sm flex items-center gap-4 hover:bg-black transition-colors shadow-lg shadow-gray-200"
                            >
                    ...
                    <div className="lg:col-span-4 space-y-8">
                        <div>
                            <div className="flex items-center gap-3 mb-6">
                                <div className="w-12 h-12 bg-gradient-to-br from-orange-500 to-red-600 rounded-lg flex items-center justify-center shadow-lg transform -rotate-3">
                                    <Award className="text-white w-7 h-7" />
                                </div>
                                <div>
                                    <h3 className="text-2xl font-black text-white uppercase tracking-tighter">STEM<span className="text-xs align-top ml-1">®</span></h3>
                                    <p className="text-[10px] text-white/60 font-bold uppercase tracking-widest">Accredited</p>
                                </div>
                            </div>
