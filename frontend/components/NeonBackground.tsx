...
export function NeonBackground({
    ...
    useEffect(() => {
        ...
        // Draw glowing ring
        const drawRing = (ring: NeonRing, x: number, y: number, scaleFactor: number) => {
            const radius = ring.radius * scaleFactor
    ...
    return (
        <div ref={containerRef} className={`absolute inset-0 overflow-hidden bg-white ${className}`}>
          ...
          `,
            ...
            <div
                ...
                style={{
                    background:
                        "radial-gradient(ellipse at center, transparent 0%, transparent 30%, rgba(255,255,255,0.95) 100%)",
                }}
            />
