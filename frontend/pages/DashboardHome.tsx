...
import { LogOut, Layout, Target, Zap, Shield, BookOpen } from 'lucide-react';
                        ...
                        {features.map((feature, i) => (
                            ...
                            >
                                <Link to={feature.to}>
                                    ...
                                    <h3 className="text-lg font-bold text-[#111827] uppercase mb-2 tracking-tight group-hover:text-[#7C3AED] transition-colors">{feature.title}</h3>
                    ...
                    <section className="grid lg:grid-cols-2 gap-8">
                        ...
                        >
                            <div className="relative z-10">
                                <span className="text-[10px] font-black text-[#A78BFA] uppercase tracking-[0.4em] mb-4 block">Our Philosophy</span>
                                <h2 className="text-3xl font-bold uppercase tracking-tight mb-6 leading-tight">Engineering Excellence Through Clinical Evidence.</h2>
                        ...
                        >
                            <h2 className="text-3xl font-bold text-[#111827] uppercase tracking-tight mb-6 leading-tight">Unlock Your Career Growth.</h2>
