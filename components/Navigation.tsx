...
const JobPrepDropdown = () => (
  <div className="grid grid-cols-1 md:grid-cols-4 gap-3 w-full">
    <BentoCard to="/job-prep/portfolio" title="Build your Portfolio" desc="Showcase your verified engineering evidence automatically." className="md:col-span-2 md:row-span-2 min-h-[160px] md:min-h-[180px]">
      <div className="mt-1 bg-[#0F172A] rounded-lg p-3 shadow-xl border border-white/10 group-hover:scale-[1.02] transition-transform">
        <div className="flex items-center gap-1 mb-1.5">
           <div className="w-1 h-1 rounded-full bg-red-400"></div>
           <div className="w-1 h-1 rounded-full bg-yellow-400"></div>
           <div className="w-1 h-1 rounded-full bg-green-400"></div>
        </div>
        <div className="space-y-1.5"><div className="h-2 w-2/3 bg-white/10 rounded"></div><div className="h-10 w-full bg-gradient-to-tr from-[#7C3AED]/30 to-transparent rounded border border-white/5"></div></div>
      </div>
    </BentoCard>
      ...
      <nav className="fixed top-0 z-[100] w-full px-2 py-4 sm:px-6 sm:py-6 lg:px-12">
        <div className="max-w-7xl mx-auto relative" onMouseLeave={handleMouseLeave}>
          ...
          >
            ...
            {/* Right Action Button */}
            <div className="flex items-center lg:w-[250px] justify-end shrink-0">
              <motion.button 
              ...
              >
                <div className="p-6 space-y-8">
                  ...
                  <div className="p-6 bg-[#F5F3FF] rounded-2xl border border-[#7C3AED]/5">
                    <p className="text-[9px] font-bold text-[#7C3AED]/60 uppercase tracking-widest mb-2">Member Access</p>
                    <button 
